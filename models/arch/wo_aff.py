...
class DRNet_wo_aff(torch.nn.Module):
    ...
    se_reduction=None, res_scale=1, bottom_kernel_size=3, pyramid=False):
        super(DRNet_wo_aff, self).__init__()
    ...
    def forward(self, x, adv_pred):
        ...
        out_enc_level2 = out_enc_level2.to(self.device1)
        out_enc_level1 = out_enc_level1.to(self.device1)
        #######
