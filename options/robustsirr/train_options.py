...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--lambda_tri', type=float, default=0.1, help='weight for tri loss')
        
        # for attack training
        self.parser.add_argument('--wo_aid', action='store_true', help='w/o aid module')
        self.parser.add_argument('--wo_aff', action='store_true', help='w/o aff module')
        self.parser.add_argument('--wo_scm', action='store_true', help='w/o scm module')
        
        self.parser.add_argument('--clean', action='store_true', help='use clean images')
