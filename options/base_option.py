...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--model', type=str, default='robustsirr_model', help='chooses which model to use.', choices=model_names)
        ...
        self.parser.add_argument('--checkpoints_pre', type=str, default='./checkpoints', help='models pre here')
